            ...
            <>
                  ...
                  <section id="home" className=" flex justify-center items-start md:items-center w-full h-screen pt-8   ">
                        ...
                        <section className=" flex flex-col items-center gap-8 px-2 pt-2 max-w-lg  md:gap-12 md:pt-18  md:max-w-3xl lg:max-w-4xl ">
                              ...
                              <h1 className=" px-2 md:px-8 xl:px-2 font-geist text-2xl text-center font-bold md:text-4xl lg:text-5xl xl:text-6xl ">Construyo interfaces web que combinan <span className=' text-primary '>rendimiento técnico</span> con <span className=' text-primary '>experiencia de usuario</span>.</h1>
                              <p className=" px-4 text-center text-md text-text leading-6 md:max-w-xl lg:max-w-3xl lg:text-lg lg:leading-8 ">Soy un desarrollador Frontend especializado en React, TypeScript y Tailwind. Me apasiona crear experiencias web rápidas, accesibles y escalables que resuelven problemas reales de usuarios.</p>
                              <section className=" flex flex-col gap-3 items-center lg:mt-10 ">
                                    <a href="#projects" className=" flex items-center gap-3 py-1.5 px-3 mb-4 rounded-md text-[.8rem] bg-primary font-semibold tracking-wider text-background md:transition-all md:duration-200 md:hover:shadow-lg md:hover:-translate-y-0.5 md:hover:bg-primary-hover group ">Ver Proyectos <ArrowRight size={12} className=" group-hover:translate-x-1 transition-transform " /></a>
