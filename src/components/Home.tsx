...
const Home = () => {
      ...
      return (
            <>
                  {/* Contenedor Home */}
                  <section id="home" className=" flex justify-center items-center w-full pt-20  ">
                        ...
                        <section className=" flex flex-col items-center gap-8 px-2 pt-2 max-w-lg  md:gap-12 md:pt-18  md:max-w-3xl lg:max-w-4xl ">
                              ...
                              <section className=" flex flex-col gap-3 items-center lg:mt-10 ">
                                    <a href="#projects" className=" flex items-center gap-3 py-1.5 px-3 rounded-md text-[.7rem] bg-primary text-background md:transition-all md:duration-200 md:hover:shadow-lg md:hover:-translate-y-0.5 md:hover:bg-primary-hover group ">Ver Proyectos <ArrowRight size={12} className=" group-hover:translate-x-1 transition-transform " /></a>
                                    ...
                                    <section className=" pt-3 pb-2 mt-6 md:mt-20 xl:mt-12  rounded-full border border-secondary ">
