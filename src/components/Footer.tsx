...
const Footer = () => {
      return (
            <>
                  ...
                  <section className=" flex flex-col items-center my-3 pb-20 ">
                        <p className=" px-20 text-sm text-center  ">Diseñado🎨 y Desarrollado ⚒️ con 💪 por <span className=" font-bold ">Pablo Zallio Dev</span> — 2026</p>
